...
canteen s;
int rn,flag=0;
cout<<"\n\nENTER SERIAL NUMBER YOU WANT TO DELETE";
cin>>rn;
while(fin.read((char*)&s,sizeof(s)))
{
if(s.retsn()==rn)
...
//************************************************************************
	...
	int random();//helps in generating random char everytime loops executes
	while(1)
		{
		k=getch();
		...
		//t=random(58)+65;//to chose char within alphabet ascii value
		cout<<t;        //alphabets lie between 65 and 122
		i++;
		}
	pass[i]='\0'; //to make it string
	if(strcmpi(pass,"atria")==0)
		{
		cout<<"\n\n Access Granted.\n\n\n\n\n\t";
